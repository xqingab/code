 ...
 * @since 2012-12-18
 */
public class CourseDtoForSave implements Serializable {
	 ...
	 * @param credit
	 */
	public CourseDtoForSave(int id, String name, String teachTime,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CourseDtoForSave other = (CourseDtoForSave) obj;
	...
	public String toString() {
		return "CourseDtoForShow [name=" + name + ", teachTime=" + teachTime
