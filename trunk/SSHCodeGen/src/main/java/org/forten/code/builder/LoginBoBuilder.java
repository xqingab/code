...
public class LoginBoBuilder {
	public static boolean buildFile() throws IOException, TemplateException,
			SQLException {
		...
		basePath = basePath + "LoginBo.java";
		...
		Template temp = cfg.getTemplate("LoginBo.ftl");
