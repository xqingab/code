...
public class LogAspect {
	@Before("@annotation(org.forten.sample.aspect.PrintLog)")
	...
	@After("@annotation(org.forten.sample.aspect.PrintLog)")
	...
	@AfterThrowing("@annotation(org.forten.sample.aspect.PrintLog)")
	public void throwException() {
		System.out.println("执行方法出现异常");
	}

	@AfterReturning("@annotation(org.forten.sample.aspect.PrintLog)")
